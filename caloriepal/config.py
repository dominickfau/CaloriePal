...
SCHEMA_CREATE_STATEMENT = f"CREATE DATABASE IF NOT EXISTS {SCHEMA_NAME.value} DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;"
...
DATABASE_URL_WITH_SCHEMA = f"{DATABASE_URL_WITHOUT_SCHEMA}/{SCHEMA_NAME.value}"
